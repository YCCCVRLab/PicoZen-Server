...
Perfect for nursing education, professional development, and clinical skills training. Experience hands-on learning without real-world consequences.`,
      ...
      },
      {
        ...
        description: 'The Oculus Browser brings the full web to VR. Browse websites, watch videos, and interact with web content in an immersive virtual environment.',
...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    let filteredApps = apps.filter(app => app.active !== false);
